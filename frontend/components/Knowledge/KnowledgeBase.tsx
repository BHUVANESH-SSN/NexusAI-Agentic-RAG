...
export default function KnowledgeBase() {
    ...
    useEffect(() => {
        ...
        // Optional quick-poll to check if processing finished
                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative group w-full md:w-80">
                            ...
                            <div className="relative flex items-center bg-[#0d1424] border border-white/[0.08] rounded-[12px] px-4 py-3 focus-within:border-[#F59E0B]/40 transition-colors">
                                ...
                                <input type="text" placeholder="Search documents..." className="bg-transparent border-none outline-none text-white text-sm w-full placeholder:text-white/30 font-body" />
                            </div>
                        </div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody>
                                {documents.length === 0 ? (
                                    <tr>
                                        <td colSpan={3} className="px-8 py-10 text-center text-white/50 font-body">
